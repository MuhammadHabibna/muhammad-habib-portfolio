        ...
        <section id="about" className="py-20 relative bg-white dark:bg-slate-950">
            <div className="container px-4 md:px-6">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-teal-500">
                            About Me
                        </h2>
                    ...
                    >
                        {features.map((feature, i) => (
                            <motion.div
                                ...
                                whileHover={{ y: -6 }}
                            >
                                <Card className="border-none shadow-md hover:shadow-lg hover:shadow-indigo-500/10 transition-shadow bg-slate-50 dark:bg-slate-900">
