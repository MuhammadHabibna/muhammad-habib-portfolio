...
export default async function getCroppedImg(
    ...
    // Resize if outputWidth is specified
    if (outputWidth && outputWidth > 0 && outputWidth !== pixelCrop.width) {
